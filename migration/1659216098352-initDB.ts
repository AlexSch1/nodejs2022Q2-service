...
export class initDB1659216098352 implements MigrationInterface {
    name = 'initDB1659216098352'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "favorite" DROP COLUMN "artists"`);
        await queryRunner.query(`ALTER TABLE "favorite" DROP COLUMN "albums"`);
        await queryRunner.query(`ALTER TABLE "favorite" DROP COLUMN "tracks"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "favorite" ADD "tracks" uuid array NOT NULL`);
        await queryRunner.query(`ALTER TABLE "favorite" ADD "albums" uuid array NOT NULL`);
        await queryRunner.query(`ALTER TABLE "favorite" ADD "artists" uuid array NOT NULL`);
